...
public class Observer implements IObserver {
	...
	public void actualizar(int issuer) {
		...
		double[] coordIniciales = this.coordenadasInicialesCanvas(338.083, "W", 4023.500, "N");
		if (this.primeraVez) {
			...
			double[] coordFinales = this.coordenadasInicialesCanvas(337.417, "W", 4023.100, "N");
	...
	public void test() { // Esto es para pruebas de c�lculos seg�n el ejemplo de errata, deber�a salir lo mismo
		...
		// Seg�n la foto comenzamos en 40� 23' 33'' N 3� 38' 04 '' W, o sea, 4023,55 N y 338,067 W
		// Y terminamos en 40� 23' 02'' N 3� 37' 18 '' W, o sea, 4023,033 N y 337,300 W
		
		// Para el INSIA son 40� 23' 15'' N, 3� 38' 1'' W -> 4023.25 N, 338.0166666666666 W
		// 40� 23' 08'' N, 3� 37' 50'' W -> 4023.1333333333 N, 337.8333333333 W
		//if (this.primeraVez) {
			this.primeraVez = false;
			System.out.println("COORD INICIALES");
