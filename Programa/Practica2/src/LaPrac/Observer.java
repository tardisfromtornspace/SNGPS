...
public class Observer implements IObserver {
	...
	double ajusteErrorLatitud = 0.0; // Para el canvas, si se hace a oj�metro. -0.5/60
	double ajusteErrorLongitud = 0.0; // Para el canvas, si se hace a oj�metro. 0.0
	...
	public void test() { // Esto es para pruebas de cálculos
		...
		//double longitud = longitudaGrados(337.7013); // Lo de la práctica 1, otro ejemplo, se ve que funciona
		//double latitud = latitudaGrados(4023.3004);
		double ajuste = 0.5/60; // El ajuste es porque la lectura se hizo a ojímetro
